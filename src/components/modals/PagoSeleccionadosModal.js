...
export default class PagosSeleccionadosModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            visible : false
    ...
    render() {
        return (
            <section>
                <button onClick={() => this.openModal()}  className="button button--primary button--table">Pagar seleccionados</button>
